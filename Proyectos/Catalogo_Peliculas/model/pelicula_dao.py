...
def crear_tabla():
    conexion = ConexionDB() #esta variable obtiene la conexion a la base de datos
    ...
    try:
        conexion.cursor.execute(sql)#con el metodo que creamos llamado curso ejecutamos el sql
        conexion.cerrar()#hace un commit y cierra la conexion
